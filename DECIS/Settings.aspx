...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid homepage">
                ...
                <asp:UpdatePanel ID="upMake" runat="server" UpdateMode="Conditional">
                    ...
                    <div class="col pt-5">
                        <div class="card mt-4">
                            <div class="card-body">
                                <p class="card-text">Enter the text for the new option you'd like to add and then click the Add New Option button.</p>
                                <asp:Label ID="lblMakeError" runat="server" Text="" CssClass="errorLabel" Visible="false"></asp:Label>
                                <br />
                                <asp:TextBox ID="tbMake" runat="server" placeholder="Make Name" CssClass="form-control"></asp:TextBox>
                                <asp:Button ID="btnAddMake" runat="server" Text="Add New Option" CssClass="btn btn-primary mt-3" OnClick="btnAddMake_Click" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
        ...
        <div class="row border-bottom mb-5 pb-5">
            <div class="col-8">
                <asp:UpdatePanel ID="upAssetType" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvAssetType" runat="server" AutoGenerateColumns="False" CssClass="table table-light table-striped table-bordered thead-dark">
                            <HeaderStyle CssClass="freshwater" />
                            <Columns>
                            </Columns>
                        </asp:GridView>
                    ...
                    <div class="col pt-5">
                        <div class="card mt-4">
                            <div class="card-body">
                                <p class="card-text">Enter the text for the new option you'd like to add and then click the Add New Option button.</p>
                                <asp:Label ID="lblATError" runat="server" Text="" CssClass="errorLabel" Visible="false"></asp:Label>
                                <br />
                                <asp:TextBox ID="tbAssetType" runat="server" placeholder="Make Name" CssClass="form-control"></asp:TextBox>
                                <asp:Button ID="btnAssetType" runat="server" Text="Add New Opion" CssClass="btn btn-primary mt-3" OnClick="btnAssetType_Click" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
