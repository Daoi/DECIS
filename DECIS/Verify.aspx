<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Verify.aspx.cs" Inherits="DECIS.Verify" %>
                ...
                <div class="card-body row">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-md-9">
                                <asp:TextBox ID="txtNewPassword" TextMode="Password" runat="server" CssClass="form-control mt-2" placeholder="New Password"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            <div class="col-md-9">
